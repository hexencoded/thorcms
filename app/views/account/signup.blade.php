...
@section('main')
<form class="account-form" method="POST" action="{{{ (Confide::checkAction('UserController@store')) ?: URL::to('user')  }}}" accept-charset="UTF-8">
    ...
    <fieldset>
        ...
        <div class='help-block'>
            <a href="{{{ URL::route('account.login') }}}">I already have an account</a>
        </div>
