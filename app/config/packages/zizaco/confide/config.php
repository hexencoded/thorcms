...
return array(
    ...
    */
    ...
    |
    */
    'login_form' =>             'thor::account.login',
    'signup_form' =>            'thor::account.signup',
    'forgot_password_form' =>   'thor::account.forgot_password',
    'reset_password_form' =>    'thor::account.reset_password',
    ...
    */
    ...
    'email_reset_password' =>       'thor::account.emails.passwordreset', // with $user and $token.
    'email_account_confirmation' => 'thor::account.emails.confirm', // with $user
